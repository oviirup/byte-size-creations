  ...
  return (
    <main className="container mx-auto flex min-h-dvh max-w-xl flex-col items-center justify-center px-6 md:px-8">
      ...
      <blockquote className="rounded-2xl border border-neutral-200 dark:border-neutral-800">
        <article
          className="group relative flex cursor-pointer gap-1 py-3 px-4"
          ...
          <div className="flex shrink-0 flex-col items-center gap-1">
            ...
            <span className="flex-grow flex h-16 w-px flex-1 border-r border-neutral-500/50" />
          </div>
          <div className="pb-5">
            ...
            <div className="relative">
              <button
                className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/10 bg-black/50 fill-white p-4 opacity-100 backdrop-blur-md transition-opacity disabled:opacity-0"
                tabIndex={-1}
                aria-hidden={true}
                disabled={isPlaying}>
      ...
      <div className="mt-10">
        <a
          ...
          <svg viewBox="0 0 24 24" className="fill-none size-5 stroke-current">
