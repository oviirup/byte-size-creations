...
const Menu = () => {
  ...
  return (
    <div className='relative flex'>
      <button
        type='button'
        className='relative -m-2.5 inline-flex cursor-pointer items-center justify-center rounded-md p-2.5 text-gray-700'
        onClick={() => setIsOpen((s) => !s)}>
        <span className='sr-only'>Open main menu</span>
        <svg
          viewBox='0 0 24 24'
          aria-hidden='true'
          className='start-[1.5] size-6 fill-none stroke-current'>
    ...
    <>
      ...
      <main>
        <div className='relative isolate'>
          <svg
            className='radial-mask absolute inset-x-0 -top-6 -z-10 h-[64rem] w-full stroke-gray-200/60 lg:top-0'
            aria-hidden='true'>
            <defs>
              <pattern
                id='grid_pattern'
          ...
          <div
            className='absolute left-2/4 right-0 top-0 -z-10 -ml-24 overflow-hidden blur-3xl lg:ml-24 xl:ml-48'
            aria-hidden='true'>
            ...
            <div className='mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32'>
              <div className='mx-auto max-w-2xl items-center gap-x-14 lg:mx-0 lg:flex lg:max-w-none'>
                <div className='relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl'>
                  <h1 className='text-4xl font-bold leading-none -tracking-wide text-gray-900 sm:text-6xl'>
                  ...
                  <div className='mt-10 flex items-center gap-x-6'>
                    <a
                      href='#'
                      className='rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm outline-offset-2 outline-indigo-600 hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2'>
                      Get started
                    </a>
                    <a
...
const Image = (props) => {
  return (
    <img
      className='aspect-[2/3] w-full rounded-xl border border-gray-200/50 bg-gray-900/10 object-cover shadow-lg'
      {...props}
    />
  );
};
